...
export default {
  ...
  moduleNameMapper: {
    ...
    '^@/Utilities/routing/compliancePaths$': `<rootDir>/src/Utilities/routing/compliancePaths.${compliancePlatform}.js`,
    '^@/Utilities/routing/complianceRoutePrefixes$': `<rootDir>/src/Utilities/routing/complianceRoutePrefixes.${compliancePlatform}.js`,
    ...
    '^@/Utilities/hooks/useFeatureFlag$': `<rootDir>/src/Utilities/hooks/useFeatureFlag/useFeatureFlag.${compliancePlatform}.js`,
    '^@/Utilities/hooks/useUnleashFlagsReady$': `<rootDir>/src/Utilities/hooks/useUnleashFlagsReady/useUnleashFlagsReady.${compliancePlatform}.js`,
    '^@/Utilities/hooks/useComplianceChrome$': `<rootDir>/src/Utilities/hooks/useComplianceChrome/useComplianceChrome.${compliancePlatform}.js`,
