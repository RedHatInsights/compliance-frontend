...
} from './ComplianceScore/ComplianceScore';
...
export {
  default as TabSwitcher,
  ContentTab,
  RoutedTabSwitcher,
  RoutedTabs,
} from './TabSwitcher/TabSwitcher';
export {
  StateView,
  StateViewWithError,
  StateViewPart,
} from './StateView/StateView';
export {
  default as SystemsCountWarning,
  WARNING_TEXT,
...
export {
  PolicyTypesTable,
  PolicyTypeDetailsRow,
  PolicyTypeTooltip,
} from './PolicyTypesTable';
