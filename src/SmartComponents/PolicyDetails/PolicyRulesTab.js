...
const PolicyRulesTab = ({ loading, policy }) => (
  <React.Fragment>
    ...
    >
      ...
      benchmark for systems within the policy. Click the &quot;Edit rules&quot;
      or &quot;Edit policy&quot; button to edit rules.
    </Alert>
    <PageSection variant={PageSectionVariants.light}>
      <Text component={TextVariants.p}>
        <strong>What rules are shown on this list?&nbsp;</strong>
        This view shows rules that are from the latest SSG version (
        {policy.benchmark.version}). If you are using a different version of SSG
        for systems in this policy, those rules will be different and can be
        viewed on the systems details page.
      </Text>
    </PageSection>
    <RulesTable
