...
import { useOnSave, usePolicyAssignedRules } from './hooks';
import { useEditPolicyData } from './hooks';
...
//   const location = useLocation();
  const {
    ...
    error: policyError,
  } = useEditPolicyData(policyId);
  usePolicyAssignedRules(policyId, policy, policyLoading, policyError);
