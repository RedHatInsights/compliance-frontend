import {
    Name, SSGVersion, DetailsLink, Policies, FailedRules, ComplianceScore, LastScanned
} from './Cells';
...
describe('Policies', () => {
    ...
    it('returns without error without policies', () => {
        expect(renderJson(<Policies { ...testSystem } policies={ undefined } />)).toMatchSnapshot();
    });
});
