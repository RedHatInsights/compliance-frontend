...
const useFilterConfig = (options = {}) => {
  const filterConfigBuilder = useMemo(() => new FilterConfigBuilder([]), []);
  ...
  const buildConfig = () =>
    filterConfigBuilder.buildConfiguration(onFilterUpdate, activeFilters);
