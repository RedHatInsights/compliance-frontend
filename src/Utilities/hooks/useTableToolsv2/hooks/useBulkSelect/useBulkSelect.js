...
const useBulkSelect = ({
  ...
  const selectAll = async () => {
    // TODO for this the `useQuery` REST API hook will need to be able and provide a function to fetch the API with the same filter, but without any offset/limit
